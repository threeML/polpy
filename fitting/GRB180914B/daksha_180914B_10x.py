...
czti_polarization_ts = TimeSeriesBuilder.from_polarization(name='daksha_pol', polevents='/home/polpy/polpy_test/polpy/data/180914B_PA068_face_0_10x_dakshapol.pevt',
                                              polrsp='/home/polpy/polpy_test/polpy/data/DAKSHA_POLRSP_EMIN_100_EMAX_1000_GRB180914B_0.prsp', specrsp=None,
                                               trigger_time=trigger_time)


czti_polarization_ts.set_active_time_interval('-80 - 80')
czti_polarization_ts.set_background_interval('-250--90')
...
band.xp.prior = Uniform_prior(lower_bound=450, upper_bound=455)
...
band.alpha.prior = Truncated_gaussian(mu=-0.75, sigma=0.05, lower_bound=-0.78, upper_bound=-0.72)

band.beta.bounds = (None, -1.5)
band.beta.prior = Truncated_gaussian(mu=-2.10, sigma=0.05, lower_bound=-2.15, upper_bound=-2.05)
...
bayes.results.write_to("AstroSat_CZTI_polarization_results_GRB180914B_face_0_10x.fits", overwrite=True)
...
cornerplot.savefig('180914B_10x_face_0_corner_plot.png')
...
fig=modulationcurve.savefig('180914B_10x_face_0_modulation_curve')
